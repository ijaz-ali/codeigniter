<div class="sidebar-menu">
    ...
    <div class="menu">
        <ul id="menu" >
            <li><a href="<?php echo base_url('Login/dashboard'); ?>"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
            <li><a href="<?php echo base_url('Login/AddEmployee'); ?>"><i class="fa fa-tachometer"></i> <span>Add Employee</span></a></li>
            <li><a href="<?php echo base_url('Login/ViewEmployee'); ?>"><i class="fa fa-tachometer"></i> <span>View Employee</span></a></li>
           
                
                
            <?php if ($this->session->userdata('logged_in')) { ?>
                <li><a href="<?php echo base_url('Login/Logout'); ?>"><i class="fa fa-lock"></i> <span>Logout</span></a></li>
            <?php } ?>
